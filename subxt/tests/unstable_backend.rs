...
//! Verifies that `Backend` can be implemented externally when explicitly enabled.
...
#[test]
fn external_backend_can_implement_backend() {
    fn assert_backend<B: Backend<PolkadotConfig>>() {}
    assert_backend::<ExternalBackend>();
}
