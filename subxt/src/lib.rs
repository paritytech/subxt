...
//! If the node you'd lik to interact with deviates from Polkadot or the default Substrate node in these
//! areas, you'll need to configur thie by implementing the [`crate::config::Config`] type yourself.
//!
...
//!
//! When you attempt to use any ofthese static types to interact with a node, Subxt will validate that they are
//! still compatible and issue an error if they have deviated.
//!
//! Accitionally, you can validate that the entirety of the statically generated code aligns with a node like so:
//!
//! ```no_run
//! use subxt::{ OnlineClient, PolkadotConfig };
//!
