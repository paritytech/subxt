...
/// taken from original type [`pallet_transaction_payment::types::FeeDetails<u128>`]
...
/// taken from original type [`pallet_transaction_payment::types::InclusionFee<u128>`]
...
/// taken from original type [`pallet_transaction_payment::types::RuntimeDispatchInfo<u128,Weight>`]
...
pub struct RuntimeDispatchInfo {
    ...
    ///
    /// This does not include a tip or anything else
    pub partial_fee: u128,
}

/// taken from original type [`sp_weights::weight_v2::Weight`]
#[derive(Debug, Encode, Decode, Eq, PartialEq, Copy, Clone, Default)]
pub struct Weight {
    #[codec(compact)]
...
/// taken from original type [`frame_support::dispatch::DispatchClass`]
#[derive(Debug, Encode, Decode, Eq, PartialEq, Copy, Clone)]
