...
//! We statically decode them and access the [tip](crate::blocks::ExtrinsicTransactionParams::tip()) and [account nonce](crate::blocks::ExtrinsicTransactionParams::nonce())
...
//! These are only available on V4 signed extrinsics or V5 general extrinsics. You can try to [find a specific transaction extension](crate::blocks::ExtrinsicTransactionParams::find),
//! in the returned [transaction extensions](crate::blocks::ExtrinsicTransactionParams).
//!
//! Subxt also provides utility functions to get the [tip](crate::blocks::ExtrinsicTransactionExtensions::tip()) and the
//! [account nonce](crate::blocks::ExtrinsicTransactionExtensions::nonce()) associated with an extrinsic, given its transaction extensions.
