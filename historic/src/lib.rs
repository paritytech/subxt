...
pub mod config {
    ...
    pub trait Config {
        ...
        type HistoricTypes<'a>: TypeResolver where Self: 'a;

        /// Return historic types for a given spec version.
        fn historic_types_for_spec_version(&'_ self, spec_version: u64) -> Self::HistoricTypes<'_>;
    }
    ...
    pub mod substrate {
        ...
        impl Config for SubstrateConfig {
            type Hash = H256;
            type HistoricTypes<'a> = TypeRegistrySet<'a>;

            fn historic_types_for_spec_version(&'_ self, spec_version: u64) -> Self::HistoricTypes<'_> {
                self.historic_types.for_spec_version(spec_version)
            }
        }
    }
...
pub mod client {
    ...
    pub struct ClientAtBlock<'a, T: Config + 'a, Client> {
        ...
        historic_types: T::HistoricTypes<'a>,
