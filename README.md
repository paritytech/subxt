...
- [Hyperbridge](https://github.com/polytope-labs/hyperbridge) A chain-agnostic interoperability protocol that enables the building of applications that can securely interact with any blockchain.
